...
export const signAccessToken = (id, sid) =>
  jwt.sign({ id, sid }, env.accessSecret, {
    expiresIn: "15m",
    audience: "trendsduniya-admin",
    issuer: "trendsduniya",
  });
export const signRefreshToken = (id, sid) =>
  jwt.sign({ id, sid, nonce: randomUUID() }, env.refreshSecret, {
    expiresIn: "7d",
    audience: "trendsduniya-refresh",
    issuer: "trendsduniya",
  });
